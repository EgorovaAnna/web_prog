...
urlpatterns = [
	...
	url(r'^add/([0-9]*/?)add_new_contact/$', views.add_new, name = 'add_new'),
	url(r'^add/add_some_doesnt_exist/([a-z]+[/+]?)/([0-9]*/?)$', views.add_some_doesnt_exist, name = 'add_some_doesnt_exist'),
	url(r'^add_new_some/([a-z,]+[/+]?)/([0-9]+)/$', views.add_new_some, name = 'add_new_some'),
	...
	url(r'^edit_id=([0-9]+)/$', views.edit, name = 'edit'),
	url(r'^edit_id=([0-9]+)/delete/$', views.delete, name = 'delete'),
	url(r'^edit_id=([0-9]+)/save/', views.save_changes, name = 'save_changes'),
]